...
export const MAKE_REQUEST_COMPANY = 'makeRequestCompany'
export const MAKE_REQUEST_USER = 'makeRequestUser'
export const GET_BOARDS = 'getBoards'
export const GET_ALL_LISTS = 'getAllLists'
...
export const ERROR_COMPANY = 'errorCompany'
...
export const POST_REQUEST_COMPANY = 'postRequestCompany'
...
export const VALIDATION_ERROR_COMPANY = 'validationErrorCompany'
...
export const ERROR_FILE = 'errorFile'
